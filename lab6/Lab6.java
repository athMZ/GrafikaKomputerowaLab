...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void init(GLAutoDrawable drawable) {
        ...
        float[] diffuseColor  = mapRGBcolor(96, 208, 250);
        float[] specularColor  = mapRGBcolor(48, 81, 175);
        float[] ambientColor  = mapRGBcolor(245, 172, 186);
