...
public class Lab7 extends JPanel implements GLEventListener {
	...
	private Texture textureFromResource(String resourceName) throws IOException {
        ...
        URL resiurceURL = this.getClass().getClassLoader().getResource(resourceName);
        
        //W celu użycia ImageIO należy dodać "throws IOException"
        BufferedImage img = ImageIO.read(Objects.requireNonNull(resiurceURL));
